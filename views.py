...
from utils import generate_checkin_code, update_seat_simulation, generate_qr_image, get_target_occupancy
            ...
            with st.container(border=True):
                ...
                with c2:
                    with st.popover("📱 QR", use_container_width=True):
                        st.markdown("<h4 style='text-align:center; color:white'>Scan to Check In</h4>", unsafe_allow_html=True)
                        qr_bytes = generate_qr_image(b['checkin_code'])
